...
int gve_next_initial(gve_context_t *context, char **out_target, int *io_target_size, char *out_has_next);
int gve_next_target(gve_context_t *context, char *in_source, int in_source_size, char **out_target, int *io_target_size, char *out_has_next);
