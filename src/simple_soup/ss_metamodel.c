...
int ss_new_model(ss_state **in_initial, int initial_count, ss_behavior **in_behaviors, int behavior_count, ss_soup **out_model) {
...
void ss_free_model(ss_soup *io_soup) {
